...
<b>Schritt 1:</b> Laden Sie die Python-Version 3.13.2 herunter: [Python 3.13.2 macOS 64-bit universal2 installer](https://www.python.org/ftp/python/3.13.2/python-3.13.2-macos11.pkg).

<b>Schritt 2:</b> Installieren sie diese Python-Version, indem Sie die gerade heruntergeladenen Datei öffnen.

<b>Schritt 3:</b> Öffnen Sie das Terminal (einfach erreichbar über Command+Leertaste -> "Terminal" eingeben).
